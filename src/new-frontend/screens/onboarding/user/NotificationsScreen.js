...
const NOTIFICATIONS = [
  ...
  },
  {
    id: 'product_drops',
    icon: '🛍️',
    label: 'Product drops & reviews',
    description: 'Be first to hear about new products for your hair type.',
    defaultOn: false,
  },
  {
    id: 'engagement',
  ...
  },
  {
    id: 'weekly_tips',
    icon: '🌿',
    label: 'Weekly hair tips & inspo',
    description: 'Curated for your hair type, every week.',
    defaultOn: false,
  },
];
...
export default function NotificationsScreen({ navigation, route }) {
  ...
  function handleContinue() {
    navigation.navigate('FollowCreators', { ...route.params, notificationPrefs: prefs });
  }
